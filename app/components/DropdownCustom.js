    ...
    return (
        <div className="relative inline-block w-full" ref={dropdownRef}>
            <button
                ...
                className="w-full px-3 sm:pl-[28px] sm:pr-[19px] h-[48px] sm:h-[62px] bg-white border border-[#E3E3E3] rounded-[50px] flex items-center justify-between outline-none"
            >
                <span
